...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_KEYDOWN:
		...
		if (wParam == VK_LEFT)
			Main_Camera->Rotate(rotationDeg--);
		return 0;
	default:
...
HRESULT InitialiseGraphics()
{
	...
	POS_COL_TEX_VERTEX vertices[] =
	{
		...
		// front face
		{XMFLOAT3(-1.0f, -1.0f, -1.0f),XMFLOAT4(1.0f,0.0f,6.0f,6.0f), XMFLOAT2(0.0f,1.0f) },
		{XMFLOAT3(-1.0f, 1.0f, -1.0f),XMFLOAT4(1.0f,0.0f,6.0f,6.0f), XMFLOAT2(0.0f,0.0f) },
		{XMFLOAT3(1.0f, 1.0f, -1.0f),XMFLOAT4(1.0f,0.0f,6.0f,6.0f), XMFLOAT2(1.0f,0.0f) },

		{XMFLOAT3(-1.0f, -1.0f, -1.0f),XMFLOAT4(1.0f,0.0f,6.0f,6.0f), XMFLOAT2(0.0f,1.0f) },
		{XMFLOAT3(1.0f, 1.0f, -1.0f),XMFLOAT4(1.0f,0.0f,6.0f,6.0f), XMFLOAT2(1.0f,0.0f) },
		{XMFLOAT3(1.0f, -1.0f, -1.0f),XMFLOAT4(1.0f,0.0f,6.0f,6.0f), XMFLOAT2(1.0f,1.0f) },

		// left face
		{XMFLOAT3(-1.0f, -1.0f, -1.0f),XMFLOAT4(1.0f,6.0f,0.0f,1.0f), XMFLOAT2(0.0f,1.0f) },
		{XMFLOAT3(-1.0f, -1.0f, 1.0f),XMFLOAT4(1.0f,6.0f,0.0f,1.0f), XMFLOAT2(0.0f,0.0f) },
		{XMFLOAT3(-1.0f, 1.0f, -1.0f),XMFLOAT4(1.0f,6.0f,0.0f,1.0f), XMFLOAT2(1.0f,1.0f) },

		{XMFLOAT3(-1.0f, -1.0f, 1.0f),XMFLOAT4(1.0f,6.0f,0.0f,1.0f), XMFLOAT2(0.0f,0.0f) },
		{XMFLOAT3(-1.0f, 1.0f, 1.0f),XMFLOAT4(1.0f,6.0f,0.0f,1.0f), XMFLOAT2(1.0f,0.0f) },
		{XMFLOAT3(-1.0f, 1.0f, -1.0f),XMFLOAT4(1.0f,6.0f,0.0f,1.0f), XMFLOAT2(1.0f,1.0f) },
		...
		// top face
		{ XMFLOAT3(1.0f, 1.0f, 1.0f),XMFLOAT4(0.0f,0.0f,6.0f,1.0f) , XMFLOAT2(1.0f,0.0f) },
		{XMFLOAT3(1.0f, 1.0f, -1.0f),XMFLOAT4(0.0f,0.0f,6.0f,1.0f), XMFLOAT2(1.0f,1.0f) },
		{XMFLOAT3(-1.0f, 1.0f, -1.0f),XMFLOAT4(0.0f,0.0f,6.0f,1.0f), XMFLOAT2(0.0f,1.0f) },

		{XMFLOAT3(-1.0f, 1.0f, 1.0f),XMFLOAT4(0.0f,0.0f,6.0f,1.0f), XMFLOAT2(0.0f,0.0f) },
		{XMFLOAT3(1.0f, 1.0f, 1.0f),XMFLOAT4(0.0f,0.0f,6.0f,1.0f), XMFLOAT2(1.0f,0.0f) },
		{XMFLOAT3(-1.0f, 1.0f, -1.0f),XMFLOAT4(0.0f,0.0f,6.0f,1.0f), XMFLOAT2(0.0f,1.0f) },
	...
	constant_buffer_desc.ByteWidth = 160; // MUST BE A MULTIPLE OF 16, calc from CB struct
...
void RenderFrame(void)
{
	...
	float rgba_clear_colour[4] = { 1.1f, 1.2f, 1.6f, 1.0f };
