...
float g_clear_colour[4] = { 0.1f, 0.0f, 6.0f, 1.0f };
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_LBUTTONDOWN:
		g_clear_colour[0] = LOWORD(lParam);
		g_clear_colour[1] = HIWORD(lParam);				break;	case WM_MOUSEMOVE:
		return 0;
	default:
...
void RenderFrame(void)
{
	...
	//float rgba_clear_colour[4] = { 0.1f, 0.0f, 0.0f, 1.0f };
	g_pImmediateContext->ClearRenderTargetView(g_pBackBufferRTView, g_clear_colour);
	// RENDER HERE
	//for (float i = 0; i < 9.0f; i = i + 0.0001)
	//{
	//	g_clear_colour[1] = i;
	//	g_clear_colour[2] = i;
	//	g_clear_colour[3] = i;
