...
HRESULT InitialiseGraphics()
{
	...
	/*	{XMFLOAT3(0.0f,0.9f,0.0f), XMFLOAT4(1.0f,0.0f,0.0f,1.0f)},
		...
		{XMFLOAT3(-0.9f, -0.9f,0.0), XMFLOAT4(0.0f,0.0f,1.0f,1.0f)},
		{XMFLOAT3(0.9f, -0.9f,0.9), XMFLOAT4(0.0f,0.0f,1.0f,1.0f)},*/
		...
		{XMFLOAT3(-1.0f, -1.0f, 1.0f), XMFLOAT4(1.0f,0.0f,0.0f,1.0f)},
		{XMFLOAT3(1.0f, -1.0f, 1.0f), XMFLOAT4(1.0f,0.0f,0.0f,1.0f)},		// front face
		{XMFLOAT3(-1.0f, -1.0f, -1.0f),XMFLOAT4(1.0f,0.0f,6.0f,6.0f)},
		{XMFLOAT3(-1.0f, 1.0f, -1.0f),XMFLOAT4(1.0f,0.0f,6.0f,6.0f)},
		{XMFLOAT3(1.0f, 1.0f, -1.0f),XMFLOAT4(1.0f,0.0f,6.0f,6.0f)},
		...
		// left face
		{XMFLOAT3(-1.0f, -1.0f, -1.0f),XMFLOAT4(1.0f,6.0f,0.0f,1.0f)},
		{XMFLOAT3(-1.0f, -1.0f, 1.0f),XMFLOAT4(1.0f,6.0f,0.0f,1.0f)},
		{XMFLOAT3(-1.0f, 1.0f, -1.0f),XMFLOAT4(1.0f,6.0f,0.0f,1.0f)},
		...
		{XMFLOAT3(-1.0f, -1.0f, 1.0f),XMFLOAT4(0.0f,1.0f,0.0f,1.0f) },
		{XMFLOAT3(-1.0f, -1.0f, -1.0f),XMFLOAT4(0.0f,1.0f,0.0f,1.0f) },		// top face
		{ XMFLOAT3(1.0f, 1.0f, 1.0f),XMFLOAT4(0.0f,0.0f,6.0f,1.0f) },
		{XMFLOAT3(1.0f, 1.0f, -1.0f),XMFLOAT4(0.0f,0.0f,6.0f,1.0f) },
		{XMFLOAT3(-1.0f, 1.0f, -1.0f),XMFLOAT4(0.0f,0.0f,6.0f,1.0f) },
	...
	constant_buffer_desc.ByteWidth = 80; // MUST BE A MULTIPLE OF 16, calc from CB struct
	...
	//cb0_values.RedAmount = 0.1f;//50% of vertex red value
...
void RenderFrame(void)
{
	...
	CONSTANT_BUFFER0 cb0_values;
	cb0_values.RedAmount = 3.3f;//50% of vertex red value
	//int i = rand() % 5; // changing the value of the scale every frame to a random number between 1-5
	...
	//cb0_values.NewWorldMatrix = world2 * view * projection;
